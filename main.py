...
from src.evaluate import evaluate_ir, evaluate_sentiment, summarize_ir, precision_at_k, average_precision, mean_average_precision
...
def main():
    ...
    while run <3:
        ...
        #     print(f"Model: {model_name.upper():6s} | P@{TOP_K}: {p_at_k:.4f} | AP: {ap:.4f}")
